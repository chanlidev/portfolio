  ...
  return (
    <div className="min-h-screen w-full relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <section className="w-full px-4 sm:px-8 lg:px-12 py-12 lg:py-20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                ...
                <div className="relative p-6 lg:p-8 h-full flex flex-col">
                  ...
                  <div className="space-y-4">
                    ...
                    <h3 className="text-white text-lg lg:text-xl font-normal leading-tight">
                      Designed the entire frontend from landing page to
                      dashboard
                    </h3>
              ...
              <div className="group relative overflow-hidden border border-[#FF31AC] rounded-lg backdrop-blur-sm">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(180deg, #4A044C 0%, #20083A 76%)",
                  }}
                />
