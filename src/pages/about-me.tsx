  ...
  return (
    <>
      ...
      <div className="w-full relative overflow-hidden pb-16 lg:pb-32 -mb-px">
        ...
        {/* Static Intro */}
        <div className="relative mt-16 md:mt-32 px-4 lg:px-8 z-10 max-w-3xl mx-auto text-left">
          <motion.div
        ...
        {/* Accordion */}
        <div className="relative mt-8 md:mt-12 px-4 lg:px-8 z-10 max-w-3xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
