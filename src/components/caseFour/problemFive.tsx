      ...
      <div className="max-w-[1450px] mx-auto">
        ...
        <div className="mb-20 lg:mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 max-w-7xl mx-auto px-4 text-center">
            <div className="border border-[#08BCA1] rounded-lg p-4 text-white text-sm md:text-base leading-relaxed bg-transparent">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 items-stretch">
              ...
              <div className="relative h-full">
                <h3 className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-[#08BCA1] px-2 text-sm md:text-base text-white whitespace-nowrap">
                  Mobile Experience
                </h3>
                <div className="border border-[#08BCA1] rounded-lg pt-8 p-4 bg-transparent text-center text-white text-sm md:text-base leading-relaxed space-y-2 h-full flex flex-col justify-start">
                  <p>
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
              ...
              <div className="relative">
                <h3 className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-[#08BCA1] px-2 text-sm md:text-base text-white">
                  Must Have
                </h3>
                <div className="border border-[#08BCA1] rounded-lg pt-8 p-4 bg-transparent text-center text-white text-sm md:text-base leading-relaxed space-y-2">
